...
const Navbar = () => {
    ...
    isActive ? "text-white bg-cyan-600 px-4 py-2 cursor-pointer hover:py-3 hover:px-6" : "text-black"
  }>Home</NavLink></li>
  ...
  <div className="navbar-start">
    ...
    <Link to='/' className=" btn-ghost text-xl flex justify-between items-center gap-2"><IoPawSharp className='text-red-600'  size={50}/><span className='font-bold text-2xl text-cyan-600'> WarmPaws</span></Link>
  </div>
